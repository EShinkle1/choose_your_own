...
void event4(Backpack &backpack, Stats &stats, std::string time_of_day) {
    std::cout << "As you walk along, you hear the characteristic croak of a frog. You pause0 for a moment and look around before returning on your way. \n\n";
    pause0();
    ...
    if (direction_response == 0) {
        ...
        if (response == 0) {
            ...
            std::cout << "Best to cut your losses, you decide. You pause0 for a moment and suddenly notice the sound of flowing water ahead. You decide to continue a bit further to check it out.\n\n";
            pause0();
        } 
