...
private:
    ...
    const std::vector<std::string> names = {"Food (1 day)", "Makeshift tent", "First aid kit", "Change of clothes", "Blanket", "Healing Potion", "Good luck rock", "Walking Stick"};
    const std::vector<double> weights = {2.0, 6.0, 0.5, 2.0, 3.0, 1.0, 3.0, 3.0};

public: 
    void print_inventory_options();
    bool take_item(char choice);
